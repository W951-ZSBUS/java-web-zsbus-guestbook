...
public class ReplyAction extends CommonAction {
	...
	public String insert() throws Exception {
		...
		String message = replyService.insert(reply);
	...
	public String delete() throws Exception {
		String message = replyService.delete(reply);
	...
	public String update() throws Exception {
		String message = replyService.update(reply);
	...
	public String query() throws Exception {
		List<Reply> list = replyService.queryPageList(page, rows);
		...
		jsonData.put("total", replyService.getCount());
